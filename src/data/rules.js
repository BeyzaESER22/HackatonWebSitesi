...
export const ruleCategories = [
  {
    ...
    title: 'Katılım & Takım',
    items: [
      'Türkiye\'deki herhangi bir üniversitede ön lisans veya lisans programına kayıtlı ve etkinlik tarihinde aktif öğrenciler ile son 12 ay içinde mezun olmuş, 18 yaşını tamamlamış kişiler katılabilir.',
      'Başvurular sadece resmi web sitesi üzerindeki form aracılığıyla alınır; e-posta veya sosyal medya üzerinden başvuru yapılamaz. Bir kişi yalnızca bir takım altında başvurabilir.',
      'Takımlar 3 ile 5 kişi arasında olmalıdır; bir katılımcı yalnızca bir takımda yer alabilir. Bireysel katılım kabul edilmez.',
      'Takımı olmayan ancak başvuru formunda "eşleştirilecek" seçeneğini işaretleyen yarışmacılar için düzenleyici tarafından takım formasyonu yapılır.',
      'Takım dağılması hâlinde kalan üye(ler) projeyi mevcut hâliyle küçük takım olarak sürdürebilir; ödül paylaşımı kalan üyeler arasında yapılır.',
