...
export function VisitorApplicationShell({
  children,
  className,
  leftPanelClassName,
  rightPanelClassName
          ...
          <div className="mt-12 space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-[#5C594E] leading-relaxed text-sm">
                Katılım <strong>İstinye Üniversitesi Vadi (Sarıyer)</strong> kampüsünde fiziksel olarak sağlanacaktır. Ana salon ve fuaye alanı gün boyu ziyarete açıktır.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <p className="text-[#5C594E] text-xs leading-relaxed">
                Etkinlik ile ilgili anlık duyurular ve bilgilendirmeler bu kanal üzerinden yapılacaktır. Katılmanızı öneririz.
              </p>
              <a
