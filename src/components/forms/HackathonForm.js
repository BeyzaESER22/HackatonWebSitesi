      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-white/50 leading-relaxed italic">
            Bu aşamada fikir belirtmek <strong className="text-white/80">opsiyoneldir</strong>, ancak projenizin <strong className="text-white/80">"Eğitimde Yenilik"</strong> temasına odaklanması gerekmektedir. Detaylı bilgi için <a href="/hackathon#themes" className="text-primary underline">bu kısmı</a> inceleyebilirsiniz.
          </p>
        </div>
      </div>
