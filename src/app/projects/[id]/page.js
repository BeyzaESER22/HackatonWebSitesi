              ...
              <div className="mt-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.awards.map((a, i) => (
                    <span key={i} className="inline-flex items-center gap-2 text-sm px-4 py-2 rounded-full border border-white/10 bg-white/5">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-yellow-400/70 shrink-0">
